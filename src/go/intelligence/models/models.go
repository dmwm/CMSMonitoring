...
// String representation of AllDashbaordsFetched structure
...
// annotations struct for storing specific set of keywords and
// set of dashboards to annotate when these keywords are matched in alerts.
