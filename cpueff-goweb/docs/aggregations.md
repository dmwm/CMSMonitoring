...
| **Cmssw Read Time Pct**         | agg field. value: `(sum("ChirpCMSSWReadTimeMsecs") / 1000) / sum("ChirpCMSSWElapsed")`. It does not exist for some CMS_JobTypes like `LogCollect, Cleanup`. Used ClassAds: [ChirpCMSSWReadTimeMsecs](https://cmsmonit-docs.web.cern.ch/cms-htcondor-es/cms-htcondor-es/#name-chirpcmsswreadtimemsecs), [ChirpCMSSWElapsed](https://cmsmonit-docs.web.cern.ch/cms-htcondor-es/cms-htcondor-es/#name-chirpcmsswelapsed) |
...
| **CommittedOverMaxWallTimeAvg** | agg field. value: `average of individual (60 * CommittedWallClockHr / MaxWallTimeMins)` . [MaxWallTimeMins](https://cmsmonit-docs.web.cern.ch/cms-htcondor-es/cms-htcondor-es/#name-maxwalltimemins)                                                                                                                                                                                                                  |
...
| `write_total_secs`       | `step['performance']['storage']['writeTotalSecs']` write time in secs         |
| `read_total_secs`        | `step['performance']['storage']['readTotalSecs']` read time in secs           |
