...
// incrementTmpl template function to increment index value by 1.
func addTmplF(a, b int) int {
	return a + b
}
...
func MainRouter(mongoColNames *models.MongoCollectionNames) http.Handler {
	...
	// Add custom function for templates
...

	{
		...
		e.GET("/stepchain-main", controllers.GetScTaskPage(
			mongoColNames.DatasourceTimestamp,
		...
		e.GET("/stepchain-detailed", controllers.GetScTaskCmsrunJobtypePage(
			mongoColNames.DatasourceTimestamp,
