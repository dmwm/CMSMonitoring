...
BASE_PATH=${BASE_PATH:-/project/awg/cms/CMS_DBS3_PROD_GLOBAL}
SCHEMA="CMS_DBS3_PROD_GLOBAL_OWNER"

TABLES="RELEASE_VERSIONS PROCESSING_ERAS PROCESSED_DATASETS PRIMARY_DS_TYPES PRIMARY_DATASETS PHYSICS_GROUPS PARAMETER_SET_HASHES OUTPUT_MODULE_CONFIGS \
 MIGRATION_REQUESTS MIGRATION_BLOCKS FILE_OUTPUT_MOD_CONFIGS FILE_DATA_TYPES DATA_TIERS DATASET_RUNS DATASET_OUTPUT_MOD_CONFIGS DATASET_ACCESS_TYPES \
